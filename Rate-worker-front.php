    ...
    <script>
        ...
        Module.controller("RatingsController", function($scope, $http) {
            ...
            $scope.doFetch = function() {
                /*alert($scope.uid);*/
                $http.get("Json-fetch-ratingdata.php").then(okFx, notokFx);
            ...
            $scope.dopost = function(rid, wid, index) {
                ...
                for (i = 0; i < ele.length; i++) {
                    if (ele[i].checked) {
                        ...
                        $http.get("citizen-updateRatings.php?uid=" + wid + "&rating=" + $scope.ratingsValue + "&rid=" + rid).then(ok, notok);
   ...
   <!-- <div ng-click=doFetch() class="btn btn-primary">Fetch</div>-->
    <table width="90%" class="table table-striped">
        ...
        <tr ng-repeat="obj in jsonarray">
            ...
            <td>
                <div ng-click=dopost(obj.rid,obj.wid,$index) class="btn btn-outline-dark">Post</div>
            </td>
        </tr>
    </table>
</body>
